def setup(setup_event=None):
    try:
        ...
        print("Failed to install epoll reactor, default reactor will be used instead.", e)
    
    try:
        import stratum.settings as settings
    except ImportError as e:
        print("***** Is configs.py missing? Maybe you want to copy and customize config_default.py?", e)
...
def setup_finalize(event, application):
    ...
    import stratum.socket_transport as socket_transport
    import stratum.http_transport as http_transport
    import stratum.websocket_transport as websocket_transport
